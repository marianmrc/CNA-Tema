...
public final class ChatServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<protobuf.ChatServiceOuterClass.ChatMessage,
      protobuf.ChatServiceOuterClass.ChatMessageFromServer> getChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "chat",
      requestType = protobuf.ChatServiceOuterClass.ChatMessage.class,
      responseType = protobuf.ChatServiceOuterClass.ChatMessageFromServer.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<protobuf.ChatServiceOuterClass.ChatMessage,
      protobuf.ChatServiceOuterClass.ChatMessageFromServer> getChatMethod() {
    io.grpc.MethodDescriptor<protobuf.ChatServiceOuterClass.ChatMessage, protobuf.ChatServiceOuterClass.ChatMessageFromServer> getChatMethod;
    if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
          ChatServiceGrpc.getChatMethod = getChatMethod = 
              io.grpc.MethodDescriptor.<protobuf.ChatServiceOuterClass.ChatMessage, protobuf.ChatServiceOuterClass.ChatMessageFromServer>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "ChatService", "chat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  protobuf.ChatServiceOuterClass.ChatMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  protobuf.ChatServiceOuterClass.ChatMessageFromServer.getDefaultInstance()))
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<protobuf.ChatServiceOuterClass.ChatMessage> chat(
        io.grpc.stub.StreamObserver<protobuf.ChatServiceOuterClass.ChatMessageFromServer> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                protobuf.ChatServiceOuterClass.ChatMessage,
                protobuf.ChatServiceOuterClass.ChatMessageFromServer>(
                  this, METHODID_CHAT)))
          .build();
    }
  }
  ...
  private static abstract class ChatServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return protobuf.ChatServiceOuterClass.getDescriptor();
    }
